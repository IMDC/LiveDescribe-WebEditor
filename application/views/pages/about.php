    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <h1 class="tagline">LiveDescribe @ IMDC</h1>
            </div>
        </div>
